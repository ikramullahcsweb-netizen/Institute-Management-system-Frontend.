...
function Nav() {
  ...
  const menuItems = [
    ...
    { path: "/adgenratelesson", icon: classes, label: "Lesson Materials" },
  ...
  return (
    <div className="font-sans">
      ...
      <div
        className={`fixed top-0 left-0 h-full w-[210px] bg-white border-r-2 border-gray-100 pt-[30px] px-5 z-[55] shadow-sm flex flex-col justify-between transform transition-transform duration-300
        lg:translate-x-0
