...
//       <div className="md:ml-[240px] pt-8 px-8 pb-12 flex justify-center">
        ...
        <div className="w-full max-w-[1000px] bg-white rounded-[24px] border-2 border-gray-100 shadow-xl p-4 sm:p-6 lg:p-8 transition-all">
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between pb-6 border-b-2 border-gray-100 gap-6">
            ...
            <div className="flex flex-wrap gap-2.5">
              <Link
                to="/searchusersadmin"
                className="no-underline bg-gray-100 text-gray-700 hover:bg-[#063a67] hover:text-white px-4 py-2.5 rounded-xl text-xs font-bold tracking-wide transition-all border-none outline-none shadow-sm"
              >
                🔍 Search Users
              </Link>
              ...
              <Link
                to="/adgenerateuser"
                className="no-underline bg-[#063a67] text-white hover:bg-gradient-to-r hover:from-[#da4a0c] hover:to-[#e60b45] px-4 py-2.5 rounded-xl text-xs font-bold tracking-wide transition-all border-none outline-none shadow-md"
              >
                📊 Generate Report
              </Link>
            </div>
          ...
          <div className="mt-12 text-center border-t border-gray-100 pt-5">
            <p className="text-[11px] text-gray-400 font-bold uppercase tracking-widest m-0">
              Operational Infrastructure Super Admin Profile Token Verified Locally
            </p>
          </div>
        </div>
      </div>
