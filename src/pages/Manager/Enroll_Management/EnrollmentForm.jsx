...
const EnrollmentForm = () => {
  ...
  // Pure Static Frontend Mock Arrays (No Backend Fetch Calls)
  const [students] = useState([
    { _id: "s1", username: "Ikram_MERN" },
    { _id: "s2", username: "Ali_Dev" },
    { _id: "s3", username: "Zain_React" },
  ]);
  ...
  // Class selection logic processed entirely on Client-Side
  const handleClassChange = (e) => {
    ...
    if (selectedClass) {
      ...
      // Clear values if placeholder selected
      setTeacherId("");
      setSubject("");
      setTeacher("");
      setGrade("");
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Captured Static Frontend Data Block:", mockFormData);
    toast.success("Enrollment processed successfully (UI Local Mode)!");

    // Local form reset sequence
    setStudentId("");
    setClassId("");
    setTeacherId("");
    setSubject("");
  ...
  return (
    <div className="w-full bg-slate-50 min-h-screen pb-12 font-sans">
      ...
      <div className="w-full max-w-[600px] mx-auto px-4 mt-8">
        {/* Title Dash Section */}
        <div className="border-b-2 border-gray-200 pb-4 mb-6">
          ...
          <p className="text-xs text-gray-500 font-medium">
            Assign students to active academic class frames locally
          </p>
        </div>
        ...
        <div className="bg-white border-2 border-slate-200 rounded-[20px] shadow-sm p-6 md:p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-slate-50/60 border border-slate-100 p-4 rounded-xl">
              <div className="flex flex-col gap-1.5">
                <label
