...
//               <Link 
//                  to="/signup" 
//                  className='bg-gradient-to-r from-[#1a759f] to-[#52b69a] px-5      py-2 rounded-full text-sm font-bold text-white shadow-md active:scale-95 transition-all whitespace-nowrap inline-block text-center'
// >
//   SIGN UP
// </Link>
...
//           </a>
//            <a href='#Contact' onClick={closeMenu} className='hover:text-[#1a759f] flex items-center gap-4 font-bold text-lg text-slate-700 transition-all'>
//             <FaPhone className='text-[#1a759f]' size={20}/> CONTACT US
//           </a>
